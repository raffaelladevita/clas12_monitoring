...
public class cndCheckPlots {
	...
	runNum = reqrunNum;
				...
				H_CND_beta_energy = new H2F("H_CND_beta_energy","H_CND_beta_energy",100,0,40,60,0.3,1.6);
				H_CND_beta_energy.setTitle("CND beta vs energy");
				...
				H_CND_beta_pn.setTitleX("CND p");
				H_CND_beta_e_neutral = new H2F("H_CND_beta_e_neutral","H_CND_beta_e_neutral",100,0,40,60,0.3,1.6);
				H_CND_beta_e_neutral.setTitle("CND beta vs energy for neutral");
				...
				for(int iL=0;iL<3;iL++){
						H_CND_edep_z[iL] = new H2F("H_CND_edep_z","H_CND_edep_z",100,-50,70,100,0,100);
						H_CND_edep_z[iL].setTitle("CND Edep vs z");
						...
						H_CND_edep_phi[iL].setTitle("CND Edep vs phi");
						H_CND_edep_phi[iL].setTitleX("#phi (component)");
						H_CND_edep_phi[iL].setTitleY("E (MeV)");
						H_CVT_CND_z[iL] = new H2F("H_CVT_CND_z","H_CVT_CND_z",80,0,40,80,0,40);
						H_CVT_CND_z[iL].setTitle("CND z vs CVT z");
						...
						H_CVT_CND_phi[iL].setTitle("CND #phi vs CVT #phi");
						...
						H_CND_vt_pad[iL].setTitle("CND vertex time vs pad");
						...
						H_CND_time_z_neutral[iL].setTitle("CND time vs z for neutral");
						H_CND_time_z_neutral[iL].setTitleX("CND z");
						H_CND_time_z_neutral[iL].setTitleY("CND time");
						H_CND_time_z_charged[iL] = new H2F("H_CND_time_z_charged","H_CND_time_z_charged",50,0,40,100,-5,5);
						H_CND_time_z_charged[iL].setTitle("CND time vs z for charged");
						H_CND_time_z_charged[iL].setTitleX("CND z");
						H_CND_time_z_charged[iL].setTitleY("CND time");

						H_CND_z_pad[iL] = new H2F("H_CND_z_pad","H_CND_z_pad",47,0,48,80,0,40);
						H_CND_z_pad[iL].setTitle("CND z vs pad");
						...
						H_CVT_CND_z1[iL].setTitle("CND z vs CVT z");
		...
		public void FillCND(DataBank CNDbank, DataBank CVTbank){
				...
				for(int iCND=0;iCND<CNDbank.rows();iCND++){
						...
						if(layer>0 && layer<4 && trkID==-1 ){//&& STT>-999){
								...
								if(newHit==0 && !sidehit && sector!=3 && sector!=11 &&sector!=19){
						...
						if(layer>0 && layer<4 && trkID>-1 && STT>-999 ){
								...
								H_CND_time_z_charged[layer-1].fill(z,time-STT);
										...
										for(int sector=0;sector<24;sector++){
												for(int comp=0;comp<2;comp++){
														...
														try {
																...
																if(Math.abs(resz)<4 && resz>1.5 ) resolutionz+=resz;
						...
						public void plot() {
								...
								can_cnd.cd(19);can_cnd.draw(H_CND_beta_p);can_cnd.draw(BetaPProt,"same");can_cnd.draw(BetaPPion,"same");can_cnd.getPad().getAxisZ().setLog(true);
								can_cnd.cd(20);can_cnd.draw(H_CND_beta_e_neutral);
								for(int iL=0;iL<3;iL++){
								...
								for(int iL=0;iL<3;iL++){
										can_cnd.cd(30+iL);can_cnd.draw(H_CVT_CND_z1[iL]);
								}
								...
								can_cnd.cd(45);can_cnd.draw(resot);
								can_cnd.cd(46);can_cnd.draw(resoz);
								can_cnd.cd(47);can_cnd.draw(alignz);can_cnd.draw(funcZ,"same");
								...
								can_cnd.cd(48);can_cnd.draw(alignt);can_cnd.draw(funcT,"same");
								can_cnd.cd(50);can_cnd.draw(H_CND_vt_P);		
								can_cnd.cd(49);can_cnd.draw(alignE);can_cnd.draw(funcE,"same");	
